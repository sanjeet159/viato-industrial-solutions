        ...
        <motion.div className="relative container-wide" style={{ opacity: heroOpacity }}>
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link to="/contact">
                <Button size="lg" variant="outline" className="border-primary-foreground/20 text-primary-foreground hover:bg-primary-foreground/100 font-semibold px-8 h-12 rounded-full">
                  Get in Touch
                </Button>
              </Link>
            </div>
